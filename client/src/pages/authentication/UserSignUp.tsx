  ...
  return (
    <div className="w-full space-y-1.5">
      ...
      <select
        ...
        onChange={onChange}
        required={required}
        className="w-full h-11 rounded-xl border border-gray-200 bg-white px-4 text-sm text-gray-900 transition-colors focus:border-indigo-400 focus:ring-2 focus:ring-indigo-100 outline-none appearance-none"
      >
        {options.map((option) => (
